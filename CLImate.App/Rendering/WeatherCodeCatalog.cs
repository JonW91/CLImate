...
public sealed class WeatherCodeCatalog : IWeatherCodeCatalog
{
    public WeatherDescriptor Describe(int code)
    {
        return code switch
        {
            ...
            61 or 63 or 65 => new WeatherDescriptor("Rain", "rain", AnsiColor.Blue),
            66 or 67 => new WeatherDescriptor("Freezing rain", "freezing_rain", AnsiColor.Blue),
            ...
            80 or 81 or 82 => new WeatherDescriptor("Rain showers", "rain_showers", AnsiColor.Blue),
            85 or 86 => new WeatherDescriptor("Snow showers", "snow_showers", AnsiColor.White),
            95 => new WeatherDescriptor("Thunderstorm", "thunderstorm", AnsiColor.White),
            96 or 99 => new WeatherDescriptor("Thunderstorm with hail", "thunderstorm_hail", AnsiColor.White),
